...
// GOLDEN RULE: the app writes to bid_pipeline and tender_feedback, and may INSERT
// new rows into tenders_scraped ONLY with platform='manual' (status pre-set to
// 'analyzed' so the n8n pipeline never picks them up). It never updates or deletes
// rows the scraper owns.
